                    ...
                    <div>
                        <div class="portfolio-details-content">
                            <div class="portfolio-details-title">
                                ...
                                <h3 class="portfolio-details-title">QNA 게시글 작성</h3>
                            </div>
                                ...
                                <form>
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea v-model="qnacontent" ref="qnacontent" style="width:100%; " rows="15" placeholder="Write a large text here ..."></textarea></td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
