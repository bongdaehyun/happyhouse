                    ...
                    <div>
                        <div class="portfolio-details-content">
                            <div class="portfolio-details-title">
                                ...
                                <h3 class="portfolio-details-title">QNA 게시글 수정</h3>
                            </div>
                                ...
                                <form>
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" v-model="qnatitle" ref="qnatitle" style="width:100%;" /></td>
                                        </tr>
                                        <tr>
                                            <th class="text-center">내용</th>
                                            <td><textarea v-model="qnacontent" ref="qnacontent" style="width:100%; " rows="15"></textarea></td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
...
<script>
    ...
    regist(){
        console.log(this.qnawriter+" ,"+this.getUserId)
        if(this.qnawriter!=this.getUserId)
        {
            alert("수정할 수 없습니다.")
