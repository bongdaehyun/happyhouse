...
export default {
   ...
   mounted() {
        ...
        if (window.kakao && window.kakao.maps) {
            ...
            script.src = 'http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=a3446703be8506556fa690850f5621d0&libraries=services';
        ...
        initMap() {
         // console.log(this.addr)
           ...
           // console.log(container)
            var options = {
                center: new kakao.maps.LatLng(this.addr.lat,this.addr.lng),
                level: 5
            };
            ...
            var markerPosition  = new kakao.maps.LatLng(this.addr.lat,this.addr.lng); 
            var marker = new kakao.maps.Marker({
                position: markerPosition
            });
            marker.setMap(map);// 여까지는 정상 작동
