                ...
                <div class="row footer-widget-wrapper">
                    <div class="col-lg-4 col-md-6 footer-widget">
                        ...
                        <ul class="footer-widget__list">
                            <li>SSAFY FINAL PROJECT, 2021.05.28</li>
                            <li>
                                <a href="m" class="hover-style-link">contact@ssafy.com</a>
                            </li>
                            <li>
                                <a href="#" class="hover-style-link">(+82)10-2345-6789</a>
                            </li>
                            <li>
                                <a href="#" target="_blank" class="hover-style-link hover-style-link--green">www.ssafy.com</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <div class="swiper-slide twitter-feed-slider__single">
                                        <div class="tweet">
                                            ...
                                            <div class="tweet__info">
                                                <h6 class="tweet__heading">PROJECT 1+1=1</h6>
                                                <span class="tweet__date">May 28, 2021</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-center text-md-left">
                        <span class="copyright-text">© 2021 Team1+1=1. All Rights Reserved.</span>
                    </div>
