                    ...
                    <div>
                        <div class="portfolio-details-content">
                            <div class="portfolio-details-title">
                                ...
                                <h3 class="portfolio-details-title">공지사항 게시글 수정</h3>
                            </div>
                                ...
                                <form>
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea v-model="noticecontent" ref="noticecontent" style="width:100%; " rows="15"></textarea></td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
...
<script>
    ...
    regist(){
        console.log(this.noticewriter+" ,"+this.getUserId)
        if(this.noticewriter!=this.getUserId)
        {
            alert("수정할 수 없습니다.")
            this.$router.push("/notice")
            return
        }
        http.put(`/notice/${this.getUserId}`,{
