                    ...
                    <div>
                        <div class="portfolio-details-content">
                            <div class="portfolio-details-title">
                                <a class="portfolio-categories" href="#">Important</a>
                                <h3 class="portfolio-details-title">공지사항 게시글</h3>
                            </div>
                                ...
                                <form>
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><p style="width:100%;">{{noticeData.noticetitle}}</p></td>
                                        </tr>
                                        <tr>
                                            <th class="text-center">내용</th>
                                            <td><p  style="width:100%; white-space:pre;" rows="15">{{noticeData.noticecontent}}</p>
                                        </td>
                                        </tr>
                                    </table>
                                </form>
                            ...
                            <div v-if="getUserId==noticeData.noticewriter">
...
<script>
    ...
    created(){
        ...
        http.get(`/notice/${this.$route.params.noticeid}`)
        .then(({data})=>{
            this.noticeData=data
            console.log(this.noticeData)
        }).catch(()=>(this.$router.push("/notice")))
    ...
    methods:{
        ...
        Delete(){
            if(this.getUserId!=this.noticeData.noticewriter){
                alert("작성자 이외 사람은 삭제할수 없습니다.")
                return
            }
            http.delete(`/notice/${this.$route.params.noticeid}`).then((data)=>{
                // alert("삭제 완료")
        ...
        moveModify(){
            ...
            this.$router.push({name: 'noticeModify', params: {noticeid:this.noticeData.noticeid}})
        },
